...
<link href="<?php echo BASE_URL?>styles/reset.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?php echo BASE_URL?>styles/layout.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?php echo BASE_URL?>styles/common.css" rel="stylesheet" type="text/css" media="all" />
</head>
...
<div id="register-wrapper">
	<div id="register-main">
		...
		<form id="register-form" action="save.php?source=<?php echo $source;?>" method="post">
			<ul>
				<li class="clear">
				...
				<li class="clear">
					...
					<input type="password" name="repassword" class="register-input-password side-left"/>
					<span class="prompt side_left">请输入账号信息</span>
				</li>
				<li class="clear">
					<span class="register-title side-left">验证码:</span>
					<input type="text" name="verify" class="register-input-verify side-left"/>
					<span class="prompt side-left"><img onclick="this.src='verify.php?'+Math.random();" src="verify.php"/></span>
					<span class="prompt side-left">请输入账号信息</span>
				</li>
				...
				<input type="submit" value="注册新账号" class="register-submit-button"/></li>
			</ul>
		</form>
	</div>
</div>
