...
create view carview
as
select carId,userId,a.bookId,bookName,price,bookCount,a.dateandtime from carinfo a inner join bookinfo b on a.bookId=b.bookId order by carId;
...
select * from carview;#carinfo、bookinfo多表查询
