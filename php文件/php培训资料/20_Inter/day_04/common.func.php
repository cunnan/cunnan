 ...
 */
//获得某分类下的新闻总数
function getNewsCount($typeId)
{
	global $dsql;//数据为封装类的对象
	$sql = "select count(*) as newscount from dede_archives where typeid={$typeId}";
	$result = $dsql->GetOne($sql);//执行sql语句
